...
run:
	python main.py -m ${MAX_RESULTS} --ckpt ${MODEL} --topicpath ${TOPICS} --alpha ${ALPHA} --name ${RUN_NAME} --titleboost ${TITLE_BOOST} --type ${TYPE} --beta ${BETA} --queryexp ${QUERY_EXP} --nrerank ${N_RERANK} --judgements ${JUDGMENTS}
